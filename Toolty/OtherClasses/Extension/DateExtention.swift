...
extension Date{
    ...
    static func dateFormServerDiffFormat(from string: String, format: String = "yyyy-MM-dd") -> Date?{
    ...
    static func dateTimeFromServerFormat(from string: String, format: String = "yyyy-MM-dd'T'HH:mm:ss.SSSZ") -> Date?{
        _serverFormatter.dateFormat = format
        return _serverFormatter.date(from: string)
    }
